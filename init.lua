...
vim.keymap.set("n", "<leader>me", vim.cmd.GoIfErr, { desc = "[m]ake if [e]rr block handler" })
--vim.keymap.set('n', '<leader>gjt', vim.cmd.GoTagAdd 'json', { desc = '[g]enerate [j]son [t]ags' })
-- [[ Basic Autocommands ]]
